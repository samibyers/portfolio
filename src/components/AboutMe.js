...
function AboutMe() {
  return (
    ...
    <section className="body">
        ...
        <div id="card">
            <p>I am a Full Stack Web Developer with a background in Molecular Biology and professional experience in healthcare. I recently earned a certificate from the University of Washington in Full Stack Web Development, where I developed skills in JavaScript, HTML, CSS, React.js, Git, and responsive web design, and more.</p>
